...
import PelulusPage from "../PelulusPage/PelulusPage";
// ~cb-add-import~
...
<li
                onClick={() => {
                  setCurrentActiveTab2("pelulus");
                }}
                className={classNames("mb-3 flex align-items-start p-3", {
                  "bg-yellow-700": props?.currentActiveTab2 === "pelulus",
                })}
                style={{ borderRadius: "12px" }}
              >
                <i
                  className="pi pi-user text-xl mr-3 "
                  style={{ color: props?.currentActiveTab2 !== "pelulus" ? "black" : "white" }}
                ></i>
                <div className="flex flex-column">
                  <span
                    className={classNames({
                      "text-white": props?.currentActiveTab2 === "pelulus",
                      "text-black": props?.currentActiveTab2 !== "pelulus",
                    })}
                  >
                  Pelulus
                  </span>
                  <p
                    className={classNames("mt-2 mb-0 line-height-3 ", {
                      "text-yellow-500": props?.currentActiveTab2 === "pelulus",
                      "text-yellow-700": props?.currentActiveTab2 !== "pelulus",
                    })}
                  >
                    Accumsan sit amet nulla facilisi morbi tempus iaculis.
                  </p>
