...
const PelulusCreateDialogComponent = (props) => {
    ...
    const onSave = async () => {
        ...
        await client.service("pelulus").patch(_entity._id, _data);
        ...
        props.onHide();
        props.alert({ type: "success", title: "Edit info", message: "Info pelulus updated successfully" });
    ...
    return (
        <Dialog header="Edit Pelulus" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max" footer={renderFooter()} resizable={false}>
            <div className="grid p-fluid overflow-y-auto"
            style={{ maxWidth: "55vw" }} role="pelulus-edit-dialog-component">
